    ...
    <header class="bgimg w3-display-container w3-grayscale-min" id="home">
        ...
        <div class="w3-display-middle w3-center">
            ...
            <div class="bottom-margin">
                <form action="{$conf->action_root}pracownikSave" method="post" class="w3-container w3-text-white ">


                    <div class="w3-input">
                        <label for="imie">Imię</label>
                        <input class="w3-input w3-black w3-border w3-round-large" id="imie" type="text"
                            placeholder="imie" name="imie" value="{$form->imie}">
                    </div>
                    <div class="w3-input"">
            <label for=" nazwisko">Nazwisko</label>
                        <input class="w3-input w3-black w3-border w3-round-large" id="nazwisko" type="text" placeholder="nazwisko" name="nazwisko" value="{$form->nazwisko}">
                    </div>
                    <div class="w3-input">
                        <label for="login">Login</label>
                        <input class="w3-input w3-black w3-border w3-round-large" id="login" type="text"
                            placeholder="login" name="login" value="{$form->login}">
                    </div>
                    <div class="w3-input">
                        <label for="haslo">Haslo</label>
                        <input class="w3-input w3-black w3-border w3-round-large" id="haslo" type="text"
                            placeholder="haslo" name="haslo" value="{$form->haslo}">
                    </div>
                    <div class="w3-input">
                        <label for="rola">Rola</label>
                        <input class="w3-input w3-black w3-border w3-round-large" id="rola" type="text"
                            placeholder="rola" name="rola" value="{$form->rola}">
                    </div>
                    <br />
                    <div class=w3-margin-bottom>
                        ...
                        <a class="w3-button w3-black w3-tiny w3-round-large"
                            href="{$conf->action_root}pracownicy">Powrót</a>
