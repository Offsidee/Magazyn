  ...
  <header class="bgimg w3-display-container w3-grayscale-min" id="home">
    ...
    <div class="w3-display-middle w3-center">
      ...
      <div class="bottom-margin">
        <form action="{$conf->action_root}materialSave" method="post" class="w3-container w3-text-white ">
          ...
          <div class="w3-input">
            ...
            <input class="w3-input w3-black w3-border w3-round" id="dlugosc" type="text" placeholder="dlugosc"
              name="dlugosc" value="{$form->dlugosc}">
          </div>
          <br />
          <div class=w3-margin-bottom>
            <input type="submit" class="w3-button w3-black w3-tiny w3-round-large" value="Zapisz" />
            <a class="w3-button w3-black w3-tiny w3-round-large" href="{$conf->action_root}materialy">Powrót</a>
