...
<body>
    ...
    <header class="bgimg w3-display-container w3-grayscale-min" id="home">
        ...
        <div class="w3-display-middle w3-center">
            ...
            <form class="w3-container w3-center " action="{$conf->action_url}pracownicy"><br />

                <input class="w3-input w3-black w3-round-large w3-animate-input w3-center " type="text" " 
                placeholder="nazwisko" name="nazwisko" value="{$searchForm->nazwisko}" /><br />
                ...
                <a href="{$conf->action_root}pracownikNew" class="w3-button w3-circle w3-black w3-display-right"
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="  w3-button w3-black w3-tiny w3-round-large"
                                href="{$conf->action_url}pracownikEdit/{$p['id']}">Edytuj</a>
                            &nbsp;
                            <a class="w3-button w3-black w3-tiny w3-round-large"
                                href="{$conf->action_url}pracownikDelete/{$p['id']}">Usuń</a>
                        </td>
                    </tr>
                    {/strip}
                    {/foreach}
